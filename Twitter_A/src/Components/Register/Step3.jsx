    ...
    return (
        <>
            <div style={{display:sms?"none":"block"}} className={Styles.mainDiv}>
                <div className={Styles.crosss}> <Link to="/step2"> <KeyboardBackspaceIcon /> </Link><h4 className={Styles.heading}>Step 3 of 3</h4></div>
                ...
                <div className={Styles.innerDiv}>
                    <div className={Styles.inputField}>
                        <div className="floating mx-auto">
                            ...
                            <div className="form-floating">
                                <input type="text" className="form-control input-phone" id="floatingPassword" placeholder="Password" value={user.emph}/>
                                <label for="floatingPassword">Email/Phone</label>
                            </div>
                    ...
                    <div className={Styles.nextBtnDiv}><button className={Styles.nextbtn} onClick={(e)=>{let result = onSignInSubmit(e)}}>Sign up</button></div>
                </div>
                <div>
              </div>
            ...
            <div style={{display:sms?"block":"none"}} className={Styles.mainDiv}>
                <div className={Styles.crosss}> <Link to="/step3"> <KeyboardBackspaceIcon /> </Link></div>
