...
export const Register = () => {
    ...
    let date = [];
    let dis = true;
    if(detail.name !="" && detail.emph != "" && detail.dob != "")
    {
        dis = false
    }
        ...
        <>
            <div className={Styles.mainDiv}>
                ...
                <form action="">
                    <div className={Styles.inputField}>
                        <div className="floating mx-auto">
                            ...
                            <div className="form-floating">
                                <input type="email" className="form-control input-phone" id="floatingPassword" placeholder="Phone|Email" onChange={(e)=>{setDetail({...detail,emph:e.target.value})}}/>
                    ...
                    <div className={Styles.nextBtnDiv}> <Link to="/step2"> <button disabled={dis} style={{background:dis?"rgb(94, 91, 91)":"black"}} className={Styles.nextbtn} onClick={()=>{
                        console.log("Hello")
